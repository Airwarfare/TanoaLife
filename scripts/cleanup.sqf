...
#define PUSH(A,B) A set [count (A),B];  //The script is messed up on these forums, the smiley face is (A,B ) no space from the B
#define REM(A,B) A=A-[B]; //The script is messed up on these forums, the smiley face is (A,B ) no space from the B
